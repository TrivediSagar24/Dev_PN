...
-(void)awakeFromNib{
    ...
    self.contentInset = UIEdgeInsetsMake(0, 10, 5, 5);
...
- (void)commonInit
{
    ...
    _placeholderTextColor = [CustomPlaceHolderTextView defaultiOSPlaceholderColor];
...
- (UIFont *)defaultFloatingLabelFont
{
    ...
    return [UIFont fontWithName:textViewFont.fontName size:roundf(textViewFont.pointSize * 1.0f)];
}
