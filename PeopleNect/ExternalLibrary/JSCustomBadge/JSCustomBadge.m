...
- (void)autoBadgeSizeWithString:(NSString *)badgeString
{
    ...
    CGSize Size = [badgeString sizeWithAttributes:
...
- (void)drawRect:(CGRect)rect
{
	...
	if([self.badgeText length] > 0.0f) {
        ...
        CGSize Size = [self.badgeText sizeWithAttributes:
        ...
        [self.badgeText drawAtPoint:CGPointMake((rect.size.width/2.0f - textSize.width/2.0f),
                                                (rect.size.height/2.0f - textSize.height/2.0f)) withAttributes:@{NSFontAttributeName:textFont}];
	}
}
